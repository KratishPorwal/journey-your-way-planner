...
import { MapPin, Calendar, Utensils, Mountain, Waves, Museum, Camera } from 'lucide-react';
    ...
    itinerary: [
      {
        ...
        activities: [
          ...
          { name: 'Cultural dance performance', icon: <Museum className="h-4 w-4" />, time: '19:00 - 20:30' }
        ]
      },
      {
        day: 2,
        ...
        activities: [
          { name: 'Visit Uluwatu Temple', icon: <Museum className="h-4 w-4" />, time: '09:00 - 11:00' },
    ...
    itinerary: [
      {
        ...
        activities: [
          { name: 'Visit Fushimi Inari Shrine', icon: <Museum className="h-4 w-4" />, time: '08:00 - 10:30' },
          ...
          { name: 'Explore Kiyomizu-dera Temple', icon: <Museum className="h-4 w-4" />, time: '15:00 - 17:30' },
      ...
      },
      {
        ...
        activities: [
          ...
          { name: 'Visit Tenryu-ji Temple', icon: <Museum className="h-4 w-4" />, time: '11:00 - 12:30' },
      ...
      },
      {
        ...
        activities: [
          { name: 'Kyoto Imperial Palace tour', icon: <Museum className="h-4 w-4" />, time: '09:00 - 11:00' },
          { name: 'Visit Nijo Castle', icon: <Museum className="h-4 w-4" />, time: '11:30 - 13:30' },
          ...
          { name: 'Geisha performance', icon: <Museum className="h-4 w-4" />, time: '19:00 - 21:00' }
        ]
      }
    ]
  },
    ...
    itinerary: [
      {
        ...
        activities: [
          ...
          { name: 'Visit Oia Castle', icon: <Museum className="h-4 w-4" />, time: '10:30 - 12:00' },
      ...
      },
      {
        ...
        title: 'History & Wine',
        activities: [
          { name: 'Visit Ancient Thera', icon: <Museum className="h-4 w-4" />, time: '09:00 - 11:30' },
    ...
    itinerary: [
      {
        ...
        activities: [
          { name: 'Visit Burj Khalifa', icon: <Museum className="h-4 w-4" />, time: '09:00 - 11:00' },
      ...
      },
      {
        ...
        activities: [
          { name: 'Al Fahidi Historical District', icon: <Museum className="h-4 w-4" />, time: '09:00 - 11:00' },
          { name: 'Dubai Museum tour', icon: <Museum className="h-4 w-4" />, time: '11:30 - 13:00' },
    ...
    itinerary: [
      {
        ...
        title: 'Classic Paris',
        activities: [
          { name: 'Visit Eiffel Tower', icon: <Museum className="h-4 w-4" />, time: '09:00 - 11:30' },
          ...
          { name: 'Evening at Arc de Triomphe', icon: <Museum className="h-4 w-4" />, time: '19:00 - 20:30' }
        ]
      },
      {
        day: 2,
        title: 'Art & Culture',
        activities: [
          { name: 'Louvre Museum', icon: <Museum className="h-4 w-4" />, time: '09:00 - 12:30' },
          { name: 'Lunch in Le Marais', icon: <Utensils className="h-4 w-4" />, time: '13:00 - 14:30' },
          { name: 'Centre Pompidou', icon: <Museum className="h-4 w-4" />, time: '15:00 - 17:00' },
      ...
      },
      {
        ...
        activities: [
          ...
          { name: 'Visit Sacré-Cœur', icon: <Museum className="h-4 w-4" />, time: '12:00 - 13:00' },
    ...
    itinerary: [
      {
        ...
        activities: [
          ...
          { name: 'Bahia Palace tour', icon: <Museum className="h-4 w-4" />, time: '16:00 - 17:30' },
      ...
      },
      {
        ...
        activities: [
          ...
          { name: 'Yves Saint Laurent Museum', icon: <Museum className="h-4 w-4" />, time: '11:30 - 13:00' },
      ...
      },
      {
        ...
        activities: [
          ...
          { name: 'Visit Berber village', icon: <Museum className="h-4 w-4" />, time: '10:30 - 12:00' },
